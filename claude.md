...
## Эталонный файл
massage/klassicheskiy/index.html — эталон дизайна и структуры.
Новые страницы создаются через генератор (generator/), не копированием вручную.

## Сквозные блоки (эталон: massage/klassicheskiy/index.html)
- Хедер — точная копия
- Футер — точная копия
